...
$resultaDaQueryInsert = mysqli_query ($conexao, "UPDATE agenda SET  date_evento = '$nova_data', responsavel_evento = '$responsavel', hora_inicio = '$hora_inicio',hora_fim = '$hora_fim', local_evento = '$local'  WHERE id_evento = '$codigo'");
